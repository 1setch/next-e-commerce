...
const CartItem = ({ name, size, color, colorHex, price }: CartItemProps) => {
    return (
        <div className={styles.item}>
            <div className={styles.imageWrap}>
                <Image src={shirt} alt={name} className={styles.image} />
            </div>
