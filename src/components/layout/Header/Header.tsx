...
const navItems = [
  ...
  { label: 'Распродажа ', href: '/catalog?discount=true' },
  { label: 'Новинки', href: '/catalog?isNew=true' },
];
        ...
        <Container>
          <div className={styles.header}>
            ...
            <div className={styles.profile}>
              <Button variant="ghost" className={styles.search_btn}>
              ...
              <Link href="/profile" className={styles.cartBtn}>
